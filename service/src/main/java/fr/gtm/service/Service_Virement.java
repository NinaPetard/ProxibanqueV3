...
//
//		CompteJpaController dc = new CompteJpaController ();
...
//
//		if (okcompte1 == false ) {
//			txt = "Le compte d�biteur n'a pas pu �tre trouv�";
//			return txt;
//		}
//
//		else if (okcompte2 == false) {
//			txt = "Le compte cr�diteur n'a pas pu �tre trouv�";
//			return txt;
//		}	
...
//		
//		if (oksolde1 == false) {			
//			txt = txt + "Le compte d�biteur n'a pas un solde suffisant pour effectuer le virement";
//			return txt;
//		}
//		
//		if (idcomptedebit == idcomptecredit) {			
//			txt = txt + "Le compte d�biteur et le compte cr�diteur sont les m�mes";
//			return txt;
//		}
//		
...
//		
//		if(okclient == false) {
//		txt = txt + "Vous n'�tes pas le gestionnaire de ce compte";
//		return txt;
//		}
//					
//		
...
//		txt = "Le virement a bien �t� effectu�";
//		return txt;
//	}
